...
#### `/cinemasformoive/:nm_movieid` 增加接口：获得某一个电影的所有影院

请求方式：GET

注意，传入的id是nm_movieid(糯米movieid，并不是那个简单的id)

返回信息同影院信息

#### `/moviesforcinema/:nm_cinemaid` 增加接口: 获得某一个影院的所有电影

请求方式：GET

注意，传入的id是nm_cinema(糯米cinemaid，并不是那个简单的id)
